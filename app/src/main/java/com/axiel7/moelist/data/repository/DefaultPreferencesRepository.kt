...
class DefaultPreferencesRepository(
    ...
    companion object {
        ...
        val ANIME_LIST_SORT_KEY = stringPreferencesKey("anime_list_sort")
        val MANGA_LIST_SORT_KEY = stringPreferencesKey("manga_list_sort")

        val START_TAB_KEY = stringPreferencesKey("start_tab")
        val TITLE_LANG_KEY = stringPreferencesKey("title_lang")
        val USE_LIST_TABS_KEY = booleanPreferencesKey("use_list_tabs")
        val LOAD_CHARACTERS_KEY = booleanPreferencesKey("load_characters")
        val RANDOM_LIST_ENTRY_KEY = booleanPreferencesKey("random_list_entry_enabled")

        val GENERAL_LIST_STYLE_KEY = stringPreferencesKey("list_display_mode")
        val USE_GENERAL_LIST_STYLE_KEY = booleanPreferencesKey("use_general_list_style")
        val GRID_ITEMS_PER_ROW_KEY = intPreferencesKey("grid_items_per_row")

        val ANIME_CURRENT_LIST_STYLE_KEY = stringPreferencesKey("anime_current_list_style")
        val ANIME_PLANNED_LIST_STYLE_KEY = stringPreferencesKey("anime_planned_list_style")
        val ANIME_COMPLETED_LIST_STYLE_KEY = stringPreferencesKey("anime_completed_list_style")
        val ANIME_PAUSED_LIST_STYLE_KEY = stringPreferencesKey("anime_paused_list_style")
        val ANIME_DROPPED_LIST_STYLE_KEY = stringPreferencesKey("anime_dropped_list_style")
        val MANGA_CURRENT_LIST_STYLE_KEY = stringPreferencesKey("manga_current_list_style")
        val MANGA_PLANNED_LIST_STYLE_KEY = stringPreferencesKey("manga_planned_list_style")
        val MANGA_COMPLETED_LIST_STYLE_KEY = stringPreferencesKey("manga_completed_list_style")
        val MANGA_PAUSED_LIST_STYLE_KEY = stringPreferencesKey("manga_paused_list_style")
        val MANGA_DROPPED_LIST_STYLE_KEY = stringPreferencesKey("manga_dropped_list_style")
    }
}